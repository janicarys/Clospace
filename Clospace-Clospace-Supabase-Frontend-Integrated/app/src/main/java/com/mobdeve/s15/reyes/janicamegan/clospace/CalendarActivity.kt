    ...
    private fun generateCalendar(): List<CalendarDay> {
        ...
        val outfitMap = mapOf(
            ...
            LocalDate.of(2026, 7, 31) to mutableListOf(
                Outfit(ownerId = -1, caption = "Sample", occasion = "Casual", plannedDate = "2026-07-31")
            ),

            LocalDate.of(2026, 8, 3) to mutableListOf(
                Outfit(ownerId = -1, caption = "Sample 1", occasion = "Casual", plannedDate = "2026-08-03"),
                Outfit(ownerId = -1, caption = "Sample 2", occasion = "Casual", plannedDate = "2026-08-03")
            ),

            LocalDate.of(2026, 8, 6) to mutableListOf(
                Outfit(ownerId = -1, caption = "Sample", occasion = "Casual", plannedDate = "2026-08-06")
            ),

            LocalDate.of(2026, 8, 11) to mutableListOf(
                Outfit(ownerId = -1, caption = "Sample", occasion = "Casual", plannedDate = "2026-08-11")
            ),

            LocalDate.of(2026, 9, 1) to mutableListOf(
                Outfit(ownerId = -1, caption = "Sample", occasion = "Casual", plannedDate = "2026-09-01")
            )
