...
import com.mobdeve.s15.reyes.janicamegan.clospace.util.applyBottomInsetAsHeightAndPadding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.layoutBottomNav).applyBottomInsetAsHeightAndPadding()
